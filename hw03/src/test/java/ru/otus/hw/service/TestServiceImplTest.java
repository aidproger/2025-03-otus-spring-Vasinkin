...
public class TestServiceImplTest {
    ...
    void shouldCorrectTestingStudentByQuestions() {
        ...
        given(ioService.readIntForRangeWithPromptLocalized(1, 3,
                "TestService.choose.number.of.right.answer",
                "TestService.choose.number.of.right.answer.error")).willReturn(1);
        given(ioService.readIntForRangeWithPromptLocalized(1, 4,
                "TestService.choose.number.of.right.answer",
                "TestService.choose.number.of.right.answer.error")).willReturn(1);
        ...
        verify(ioService, times(1)).printLineLocalized(stringCaptor.capture());
        verify(ioService, times(8)).printLine(stringCaptor.capture());
