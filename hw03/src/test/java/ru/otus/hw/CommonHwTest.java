...
@DisplayName("Проверка внедрения зависимостей и аннотаций класса свойств ")
class CommonHwTest {

    private static final String CONFIGURATION_ANNOTATION_NAME = "org.springframework.context.annotation.Configuration";

    @DisplayName("не должен содержать аннотацию '@Configuration' над классом свойств ")
    @Test
    ...
    @DisplayName("не должен содержать аннотацию '@PropertySource' над классом свойств ")
    @Test
    ...
    @DisplayName("должны осуществлять внедрение через конструктор ")
    @Test
