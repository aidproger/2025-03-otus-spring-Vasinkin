...
function saveBook() {
    ...
    const authorsSelectedOption = authorsSelect.options[authorsSelect.selectedIndex];
    ...
    let book = { title: bookTitle.value,
                 author: authorsSelect.value==""?null:
                   { id: authorsSelectedOption.value, fullName: authorsSelectedOption.text },
                 genres: genres
        };
