...
public class DataJpaCommentRepositoryTest {
    ...
    void shouldSaveNewComment() {
        var expectedComment = new Comment(0, "CommentText_10500",
                LocalDateTime.of(2026, 1, 1, 0, 0, 0), dbBooks.get(0));
    ...
    void shouldSaveUpdatedComment() {
        var expectedComment = new Comment(SECOND_COMMENT_ID, "CommentText_10500",
                LocalDateTime.of(2026, 1, 1, 0, 0, 0), dbBooks.get(0));
